...
bet.addEventListener("click", () => {
    ...
    const userTurnChoice = document.getElementById("turn").value
    ...
    async function playSequence(bullet, elem) {
        ...
        if (userChoice == killed && userTurnChoice == killedTurn) {
            console.log("You won");
            result.innerHTML = `You Won<br>${amount} x 10: ${amount*10}rs 🤑`;
